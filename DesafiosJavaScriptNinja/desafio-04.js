...
console.log(isTruthy({name: 'Alexandre'}));
...
*/
carro.adicionarPessoas = (npessoas) => {
    const totalPessoas = carro.quantidadePessoas + npessoas;
    if(carro.quantidadePessoas === carro.assentos){
        return 'O carro já está cheio!';
    }
    if(totalPessoas > carro.assentos){
        const quantasPessoasCabem = carro.assentos - carro.quantidadePessoas;
        const pluralSingular = quantasPessoasCabem === 1 ? ' pessoa' : ' pessoas';
...
// E agora, qual a cor do carro?
console.log(carro.obterCor()); //ver musgo.

// Qual a marca e modelo do carro?
console.log(carro.obterMarcaModelo()); //Esse carro é um Renault Megane

// Adicione 2 pessoas no carro.
console.log(carro.adicionarPessoas(2)); //Já temos 2 pessoas no carro

// Adicione mais 4 pessoas no carro.
console.log(carro.adicionarPessoas(4)); //Só cabem mais 3 pessoas no carro!
...
console.log(carro.adicionarPessoas(10)); //Só cabem mais 4 pessoas no carro!
