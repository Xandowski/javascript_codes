(function () {
  ...
  */
  console.log('\nOperation:');
  const operation = justMod2Or3.reduce((acumulado, atual) => {
  ...
  */
  console.log('\nOperation 2:');
  const operation2 = justMod2Or3.reduceRight((acumulado, atual) => {
    return (acumulado + 1) * atual;
  }, 0);
  ...
  */
  ...
  const name = ['A', 'le', 'xan', 'dre'];
  const reduceP = name.reduce((acumulado, atual) => {
  ...
  */
  console.log('\nInversed Name:');
  const inversedName = name.reduceRight((acumulado, atual) => {
